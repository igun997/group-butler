    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          // The generated default adds `[&>button]:hidden`, which removes the
          // sheet's close control on touch: the only ways out would be tapping
          // the overlay or Escape. Kept visible so the sheet can be dismissed by
          // the control it shows.
...
/**
 * The console's content column. A `div`, not a `main`: the shell's own
 * `<main id="content">` inside it is the page's one landmark, and nesting two
 * would give assistive technology two answers to "where is the main content".
 */
